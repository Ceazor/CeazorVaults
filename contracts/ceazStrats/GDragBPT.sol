...
// Third party contracts
    ...
    bytes32 public BALPoolId = bytes32(0xd6e5824b54f64ce6f1161210bc17eebffc77e031000100000000000000000006);        // only need this to sell BAL. not at this point, viable
    ...
    bytes32 public ETHrETHPoolID = bytes32(0x4fd63966879300cafafbb35d157dc5229278ed2300020000000000000000002b);
    ...
    function _harvest() internal whenNotPaused {
        IBalancerGaugeHelper(helper).claim_rewards(address(this));
...
// performance fees
    function chargeFees(uint256 BALBal, uint256 IBBal) internal {
        ...
        if (IBBalFees > 0) {
            balancerSwap(wantPoolId, IB, native, IBBalFees);  
        }
...
// Adds liquidity to AMM and gets more LP tokens.
    function addLiquidity() internal {
        ...
        balancerSwap(ETHrETHPoolID, native, rETH, _nativeIn);
