...
interface ILQDR {
    ...
    function withdraw(uint256 pid, uint256 amount, address to) external; //withdraws leaving rewards
    function harvest(uint256 pid, address to) external; //claims rewards
